    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ["විසිපන්දහස් හයසිය විස්ස", "දෙදහස් පන්සිය හටදෙක", "විසිපන්දහස් හයසිය දෙක", "විසිපන්දහස් විස්ස"],
      ...
      questions: [
        {
          ...
          options: ["28", "32", "56", "සියල්ල සමානයි"],
          correctAnswer: "56",
        ...
        },
        {
          ...
          conceptId: "c1_number_train_station",
          interactionType: "multipleChoice",
          questionText: "541, 358, 722 අතරින් විශාලම සංඛ්‍යාව තෝරන්න.",
          options: ["541", "358", "722", "කිසිවක් නොවේ"],
          correctAnswer: "722",
        ...
        },
        {
          ...
          conceptId: "c1_number_train_station",
          interactionType: "multipleChoice",
          questionText: "28, 56, 32 කුඩාම සංඛ්‍යාවේ සිට විශාලම සංඛ්‍යාව දක්වා (ආරෝහණ පිළිවෙළට) ඇති පේළිය තෝරන්න:",
        ...
        },
        {
          ...
          conceptId: "c1_number_train_station",
          interactionType: "multipleChoice",
          questionText: "352, 258, 219 කුඩාම සංඛ්‍යාවේ සිට විශාලම සංඛ්‍යාව දක්වා පේළිගත කරන්න:",
        ...
        },
        {
          ...
          conceptId: "c1_number_train_station",
          interactionType: "multipleChoice",
          questionText: "4825, 3967, 4512 කුඩාම සංඛ්‍යාවේ සිට විශාලම සංඛ්‍යාව දක්වා පටිපාටිගත කරන්න:",
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          conceptId: "c2_number_train_ordering",
          interactionType: "multipleChoice",
          questionText: "74, 47, 81 කුඩාම සංඛ්‍යාවේ සිට විශාලම සංඛ්‍යාව දක්වා (ආරෝහණ පිළිවෙළට) සකස් කරන්න:",
        ...
        },
        {
          ...
          conceptId: "c2_number_train_ordering",
          interactionType: "multipleChoice",
          questionText: "95, 63, 88 විශාලම සංඛ්‍යාවේ සිට කුඩාම සංඛ්‍යාව දක්වා (අවරෝහණ පිළිවෙළට) සකස් කරන්න:",
        ...
        },
        {
          ...
          conceptId: "c2_number_train_ordering",
          interactionType: "multipleChoice",
          questionText: "412, 489, 450 ආරෝහණ පිළිවෙළට පෙළගස්වන්න:",
        ...
        },
        {
          ...
          conceptId: "c2_number_train_ordering",
          interactionType: "multipleChoice",
          questionText: "805, 621, 799 කුඩාම සංඛ්‍යාවේ සිට විශාලම සංඛ්‍යාව දක්වා සකස් කරන්න:",
        ...
        },
        {
          ...
          conceptId: "c2_number_train_ordering",
          interactionType: "multipleChoice",
          questionText: "5240, 2980, 5610 අවරෝහණ පිළිවෙළට (විශාලම සිට කුඩාමට) සකස් කරන්න:",
      ...
      questions: [
        {
          ...
          conceptId: "c3_digit_card_train",
          interactionType: "digitBuilder",
          questionText: "4, 6, 1, 3 ඉලක්කම් භාවිත කර 6431 සංඛ්‍යාව සාදන්න.",
          correctAnswer: "6431",
          options: ["6431", "6341", "4631", "6413"],
        ...
        },
        {
          ...
          conceptId: "c3_digit_card_train",
          interactionType: "digitBuilder",
          questionText: "දුම්රිය මැදිරියේ අංකය 5,284 විය යුතුයි. 8, 5, 4, 2 ඉලක්කම් පත් නිවැරදි අනුපිළිවෙළට තබන්න.",
          correctAnswer: "5284",
        ...
        },
        {
          ...
          conceptId: "c3_digit_card_train",
          interactionType: "digitBuilder",
          questionText: "3, 8, 1, 6 ඉලක්කම් හතරෙන් සෑදිය හැකි විශාලම සංඛ්‍යාව සාදන්න.",
          correctAnswer: "8631",
        ...
        },
        {
          ...
          conceptId: "c3_digit_card_train",
          interactionType: "digitBuilder",
          questionText: "7, 2, 9, 4 ඉලක්කම් හතරෙන් සෑදිය හැකි කුඩාම සංඛ්‍යාව සාදන්න.",
          correctAnswer: "2479",
        ...
        },
        {
          ...
          options: ["6842", "6482", "දෙකම සමානයි", "කිසිවක් නොවේ"],
          correctAnswer: "6842",
      ...
      questions: [
        {
          ...
          options: ["18508", "33240", "61088", "සියල්ල සමානයි"],
          correctAnswer: "61088",
        ...
        },
        {
          ...
          options: ["30000 + 3000 + 200 + 40 + 0", "3000 + 300 + 20 + 4", "30000 + 200 + 40", "33000 + 240"],
        ...
        },
        {
          ...
          conceptId: "c4_thousands_mountain",
          interactionType: "multipleChoice",
          questionText: "45600, 48200, 42900 කුඩාම සිට විශාලම දක්වා (ආරෝහණ පිළිවෙළට) සකස් කරන්න:",
          options: ["42900, 45600, 48200", "48200, 45600, 42900", "45600, 42900, 48200", "42900, 48200, 45600"],
        ...
        },
        {
          ...
          options: ["70,000 (දසදහස්ස්ථානය)", "7,000 (දහස්ස්ථානය)", "700 (සියයස්ථානය)", "70 (දහයස්ථානය)"],
        ...
        },
        {
          ...
          conceptId: "c4_thousands_mountain",
          interactionType: "multipleChoice",
          questionText: "54543, 14628, 76500 විශාලම සංඛ්‍යාවේ සිට කුඩාම සංඛ්‍යාව දක්වා (අවරෝහණ පිළිවෙළට) සකස් කරන්න:",
          options: ["76500, 54543, 14628", "14628, 54543, 76500", "54543, 76500, 14628", "76500, 14628, 54543"],
        ...
        },
        {
          ...
          conceptId: "c4_thousands_mountain",
          interactionType: "multipleChoice",
          questionText: "18508, 33240, 61088, 47205, 52010 කුඩාම සිට විශාලම දක්වා (ආරෝහණ පිළිවෙළට) සකස් කරන්න:",
          options: [
      ...
      questions: [
        {
          ...
          conceptId: "c5_challenge_train",
          interactionType: "multipleChoice",
          questionText: "12450, 21450, 19999 අතරින් විශාලම සංඛ්‍යාව ඇති දුම්රිය තෝරන්න.",
          options: ["12450", "21450", "19999", "සියල්ල සමානයි"],
          correctAnswer: "21450",
        ...
        },
        {
          ...
          conceptId: "c5_challenge_train",
          interactionType: "multipleChoice",
          questionText: "9876, 10205, 8999, 10025 අතරින් කුඩාම සංඛ්‍යාව තෝරන්න.",
        ...
        },
        {
          ...
          conceptId: "c5_challenge_train",
          interactionType: "multipleChoice",
          questionText: "52430, 52340, 52403 කුඩාම සිට විශාලම දක්වා (ආරෝහණ පිළිවෙළට) සකස් කරන්න:",
          options: ["52340, 52403, 52430", "52430, 52403, 52340", "52340, 52430, 52403", "52403, 52340, 52430"],
        ...
        },
        {
          ...
          conceptId: "c5_challenge_train",
          interactionType: "multipleChoice",
          questionText: "හෝඩුවාවලට (6 දසදහස්, 2 දහස්, 5 සිය) ගැළපෙන සංඛ්‍යාව තෝරන්න.",
        ...
        },
        {
          ...
          conceptId: "c5_challenge_train",
          interactionType: "multipleChoice",
          questionText: "45210, 54201, 40512, 52410 විශාලම සිට කුඩාම දක්වා (අවරෝහණ පිළිවෙළට) සකස් කරන්න:",
          options: ["54201, 52410, 45210, 40512", "40512, 45210, 52410, 54201", "54201, 45210, 52410, 40512", "52410, 54201, 45210, 40512"],
        ...
        },
        {
          ...
          conceptId: "c5_challenge_train",
          interactionType: "multipleChoice",
          questionText: "27540, 72405, 27450, 70245, 25740 කුඩාම සිට විශාලම දක්වා (ආරෝහණ පිළිවෙළට) සකස් කරන්න:",
          options: [
...
async function seed() {
  console.log("=== Seeding exact student app curriculum into Firestore (math_lessons) ===");
  const snap = await getDocs(collection(db, "math_lessons"));
  for (const d of snap.docs) {
    console.log(`Deleting previous doc: ${d.id}`);
    await deleteDoc(doc(db, "math_lessons", d.id));
  }

  // Insert Lesson 1
  const l1Ref = doc(collection(db, "math_lessons"));
  await setDoc(l1Ref, {
    ...LESSON_1,
    createdAt: serverTimestamp(),
    updatedAt: serverTimestamp(),
  });
  console.log(`✓ Seeded Lesson 1: ${LESSON_1.title} [Doc ID: ${l1Ref.id}]`);

  // Insert Lesson 2
  const l2Ref = doc(collection(db, "math_lessons"));
  await setDoc(l2Ref, {
    ...LESSON_2,
    createdAt: serverTimestamp(),
    updatedAt: serverTimestamp(),
  });
  console.log(`✓ Seeded Lesson 2: ${LESSON_2.title} [Doc ID: ${l2Ref.id}]`);

  console.log("\n🎉 Done! All 2 Lessons, 10 Concepts, and 60 Questions are now 100% identical between CMS and Student App.");
  process.exit(0);
}
